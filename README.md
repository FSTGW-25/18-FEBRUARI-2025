...
<body>
  <div class="title-box">27 Hari Lagi Kak Thania Theresia Podung Ulang Tahun! 🎉🎂🥳</div>
  ...
  <div id="photo-gallery" class="photo-gallery" style="display: none;">
    <div class="gallery-container">
      <img src="foto 2.jpeg" class="gallery-photo">
    </div>
  </div>

  <script>
    const audio = new Audio('FALLIN FLOWER.mp3');
    ...
    const fullMessage = `"🤍 Seperti kelopak bunga yang jatuh tertiup angin, terkadang kita harus melepaskan sesuatu agar bisa bertumbuh lebih indah🌻 Setiap musim membawa perubahan, dan mungkin ada saat-saat di mana kita merasa terjatuh, kehilangan arah, atau harus melepaskan sesuatu yang berharga 🍂 Namun, jangan takut! Sama seperti bunga yang gugur bukanlah akhir, tetapi awal dari perjalanan baru. ✨ Setiap perubahan dalam hidup adalah kesempatan untuk bertumbuh dan merupakan bagian dari proses indah yang membentuk diri kita. 🤍🌼`;
